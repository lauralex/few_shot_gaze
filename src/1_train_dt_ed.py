...
if __name__ == '__main__':
    global time_epoch_start, num_elapsed_epochs
...
def execute_training_step(current_step):
    global train_data_iterator, time_epoch_start, num_elapsed_epochs, is_first
    ...
    network.train()
    if is_first and enable_graph and args.use_tensorboard:
        tensorboard.add_graph(network, torch.tensor([1, 2, 3]))
        is_first = False
