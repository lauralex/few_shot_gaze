...
then
	...
	TRAIN_CMD="1_train_dt_ed.py \
        ...
        "
    eval "python -m torch.distributed.launch --nproc_per_node=8 $TRAIN_CMD --distributed; "
    eval "python $TRAIN_CMD --skip-training --generate-predictions; "
...
ML_COMMON=" --disable-tqdm --maml-use-pretrained-mlp --output-dir ./"

python 2_meta_learning.py ${ML_COMMON} ${OUTPUT_DIR}  1 &
python 2_meta_learning.py ${ML_COMMON} ${OUTPUT_DIR}  2 &
python 2_meta_learning.py ${ML_COMMON} ${OUTPUT_DIR}  3 &
python 2_meta_learning.py ${ML_COMMON} ${OUTPUT_DIR}  4 &
python 2_meta_learning.py ${ML_COMMON} ${OUTPUT_DIR}  5 &
python 2_meta_learning.py ${ML_COMMON} ${OUTPUT_DIR}  6 &
wait

python 2_meta_learning.py ${ML_COMMON} ${OUTPUT_DIR}  7 &
python 2_meta_learning.py ${ML_COMMON} ${OUTPUT_DIR}  8 &
python 2_meta_learning.py ${ML_COMMON} ${OUTPUT_DIR}  9 &
python 2_meta_learning.py ${ML_COMMON} ${OUTPUT_DIR} 10 &
python 2_meta_learning.py ${ML_COMMON} ${OUTPUT_DIR} 11 &
python 2_meta_learning.py ${ML_COMMON} ${OUTPUT_DIR} 12 &
wait

python 2_meta_learning.py ${ML_COMMON} ${OUTPUT_DIR} 13 &
python 2_meta_learning.py ${ML_COMMON} ${OUTPUT_DIR} 14 &
python 2_meta_learning.py ${ML_COMMON} ${OUTPUT_DIR} 15 &
python 2_meta_learning.py ${ML_COMMON} ${OUTPUT_DIR} 16 &
python 2_meta_learning.py ${ML_COMMON} ${OUTPUT_DIR} 17 &
python 2_meta_learning.py ${ML_COMMON} ${OUTPUT_DIR} 18 &
wait
...
python 3_combine_maml_results.py ${OUTPUT_DIR}
